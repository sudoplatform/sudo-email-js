...
export interface ListDraftsMetadataForEmailAddressIdOutput {
  emailAddressId: string
  items: DraftEmailMessageMetadataEntity[]
  nextToken?: string
}

/**
 * Output for `EmailMessageService.listDraftsMetadataForEmailAddressId` method.
 *
 ...
 * @property {EmailMessageSubscriber} subscriber Object representing the email message subscriber.
 */
...
export interface EmailMessageService {
   ...
   * @returns {ListDraftsMetadataForEmailAddressIdOutput} Information including a list of draft email message metadata, with pagination details
   */
  listDraftsMetadataForEmailAddressId(
    input: ListDraftsMetadataForEmailAddressIdInput,
  ): Promise<ListDraftsMetadataForEmailAddressIdOutput>
   ...
   *
   * @param {DeleteEmailMessagesInput} input Parameters used to delete a draft email message.
